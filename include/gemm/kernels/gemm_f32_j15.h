#ifndef __GEMM_F32_J15_H_
#define __GEMM_F32_J15_H_
...
index_t gemm_f32_j15(char transa, char transb, index_t m, index_t n, index_t k,
  ...
  for (index_t kk = 0; kk < k; kk += 1) {
    ...
    __m512 bzmm15 = _mm512_set1_ps(*(b_ptr + 14));
